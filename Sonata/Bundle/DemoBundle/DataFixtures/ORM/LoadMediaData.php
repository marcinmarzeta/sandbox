...
class LoadMediaData extends AbstractFixture implements  OrderedFixtureInterface
{
    ...
    /**
     * LoadMediaData constructor.
     * @param MediaManager $mediaManager
     * @param GalleryManagerInterface $galleryManager
     * @param Faker $faker
     */
    public function __construct(MediaManager $mediaManager, GalleryManagerInterface $galleryManager, Faker $faker)
    {
    ...
    {
        $galleryHasMedia = new \App\Application\Sonata\MediaBundle\Entity\GalleryHasMedia();
