...
{
    /**
     * @var \Sonata\ClassificationBundle\Model\ContextManagerInterface
     */
     ...
     */
    public function __construct(ContextManagerInterface $contextManager, CategoryManagerInterface $categoryManager = null)
    {
    ...
    {
        $productContext = $this->contextManager->find('sonata_product');
        // Travels category
        ...
        $travels->setContext($productContext);
        ...
        $asia->setContext($productContext);
        ...
        $japan->setContext($productContext);
        ...
        $northAmerica->setContext($productContext);
        ...
        $canada->setContext($productContext);
        ...
        $quebec->setContext($productContext);
        ...
        $europe->setContext($productContext);
        ...
        $switzerland->setContext($productContext);
        ...
        $france->setContext($productContext);
        ...
        $paris->setContext($productContext);
        ...
        $greatBritain->setContext($productContext);
        ...
        $london->setContext($productContext);
        ...
        $goodies->setContext($productContext);
        ...
        $plushes->setContext($productContext);
        ...
        $mugs->setContext($productContext);
        ...
        $clothes->setContext($productContext);
        ...
        $shoes->setContext($productContext);
