...
class LoadPageData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function __construct(SiteManagerInterface $siteManager, PageManagerInterface $pageManager,
                                BlockManagerInterface $blockManager, BlockInteractor $blockInteractor)
    {
