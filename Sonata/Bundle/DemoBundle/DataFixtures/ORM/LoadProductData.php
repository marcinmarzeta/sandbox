...
use App\Application\Sonata\ProductBundle\Entity\Delivery;
use App\Application\Sonata\ProductBundle\Entity\Goodie;
use App\Application\Sonata\ProductBundle\Entity\Travel;
use App\Application\Sonata\ProductBundle\Entity\Package;
use App\Application\Sonata\ProductBundle\Entity\ProductCategory;
use App\Application\Sonata\ProductBundle\Entity\ProductCollection;
...
class LoadProductData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function __construct(MediaManagerInterface $mediaManager, Pool $productPool, GalleryManagerInterface $galleryManager)
    {
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $this->getMediaManager()->save($defaultMedia, 'sonata_product', 'sonata.media.provider.image');
